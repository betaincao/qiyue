...
<div class="content">
    ...
    <div id="main">
        <div class="item"><span>名称</span><p><?php echo ($vo["a_name"]); ?></p></div>
        <div class="item"><span>简介</span><p><?php echo ($vo["a_detail"]); ?></p></div>
        <div class="item"><span>仪器编号</span><p><?php echo ($vo["a_num"]); ?></p></div>
        <div class="item"><span>所属实验室</span><p><?php echo ($vo["l_name"]); ?></p></div>
        <div class="item"><span>预约次数</span><p><?php echo ($vo["a_add"]); ?>次</p></div>
    <div class="bottom">
