...
<body>
   ...
   <table class="choice">
    ...
    <!-- 个人信息展示 -->
  <ul id="message" class="choice-box" style="display: block;">
    <?php if(is_array($UserInfo)): foreach($UserInfo as $key=>$vo): ?><li>
    		<img src="/qiyue/Public/Images/person.png" />
    		<p class="Specific-information">姓名</p>
    		<p class="brackets"><?php echo ($vo["u_name"]); ?></p>
    	</li>
    	<li>
    		<img src="/qiyue/Public/Images/heart.png" />
    		<p class="Specific-information">班级</p>
    		<p class="brackets"><?php echo ($vo["u_class"]); ?></p>
    	</li>
    	<li>
    		<img src="/qiyue/Public/Images/horn.png" />
    		<p class="Specific-information">学号</p>
    		<p class="brackets"><?php echo ($vo["u_stuid"]); ?></p>
    	</li>
      <li>
        <img src="/qiyue/Public/Images/horn.png" />
        <p class="Specific-information">电话号码</p>
        <p class="brackets"><?php echo ($vo["u_phone"]); ?></p>
